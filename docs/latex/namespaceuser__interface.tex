...
Within \hyperlink{user__interface_8py}{user\+\_\+interface.\+py} we find the {\ttfamily /user\+\_\+interface service}. Its purpose basically consists in providing a tool for selecting the x,y coordinates of the next desired robot target position, once the previous target has been reached. Moreover, this is the {\itshape user-\/interface} exploited by the bug algorithm 
...
Definition at line 47 of file user\+\_\+interface.\+py.
...
Definition at line 28 of file user\+\_\+interface.\+py.
